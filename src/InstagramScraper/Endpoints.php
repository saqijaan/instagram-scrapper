...
class Endpoints
{
    ...
    const GENERAL_SEARCH = 'https://www.instagram.com/web/search/topsearch/?context={context}&query={query}&count={count}';
    ...
    public static function getGeneralSearchJsonLink($query,$context = 'user', $count = 10)
    {
        $url = str_replace('{query}', urlencode($query), static::GENERAL_SEARCH);
        $url = str_replace('{context}', urlencode($context), $url);
